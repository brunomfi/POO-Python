...
class ContaBancaria:
    ...
    def sacar(self, valor):
        if valor > self.saldo:
            print(f"[bold red]Valor de saque de R$ {valor} é maior que o saldo, Valor INSUFICIENTE[/]")
        else:
            self.saldo -= valor
            print(f'[bold green]Foi feito um saque no valor de R$ {valor} e o valor total é de R$ {self.saldo}[/]')
